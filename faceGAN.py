...
# D_solver = tf.train.GradientDescentOptimizer(learning_rate=0.1).minimize(D_loss, var_list=theta_D)
# G_solver = tf.train.GradientDescentOptimizer(learning_rate=0.1).minimize(G_loss, var_list=theta_G)
